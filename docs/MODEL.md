...
Critical Path explores Thomas Kwa's worldview through a quarterly strategy model. Its coefficients make strategic tradeoffs playable. The campaign imagines future events involving real labs from a January 2026 starting point. [AI 2027](https://ai-2027.com/) and [AI 2040](https://ai-2040.com/) provide secondary scenario inspiration.
...
The game places superintelligence at ECI 225. Named labs retain their scenario advantages and starting order, rather than reproducing a historical model leaderboard. ECI conversion changes the display rather than the game's underlying capability units; forecasts and lab leads use ECI points.

The capability bars mark AGI at 175, SAR at 190, and ASI at 225 ECI. AGI represents broadly human-level cognitive work; SAR is the ability to automate frontier AI research. The [AI Futures Model milestone definitions](https://github.com/AI-Futures-Project/aifm-public/blob/1c40ecdb246c25980515441a66571931c5604e11/constants/chartExplanations.ts#L26) describe superhuman AI research and ASI.
...
These curves allow a very large AI business near superintelligence. The [AI 2027 compute forecast](https://ai-2027.com/research/compute-forecast#financials) projects $140 billion of annual revenue and $100 billion of annual compute costs for a leading AI firm in 2027. The [AI 2040 Plan A scenario](https://ai-2040.com/print/scenario?plan=A&supplements=0) puts the leading firm's annual recurring revenue at $1.5 trillion in early 2031. The game presents quarterly receipts. Firm revenue, cash reserves, profit, and world economic output are different quantities.
